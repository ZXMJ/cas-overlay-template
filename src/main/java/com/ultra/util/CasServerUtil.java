...
public class CasServerUtil {
     ...
     * 登录地址的token
     */
    private static final String GET_TOKEN_URL = CAS_SERVER_PATH + "/cas/login";


    public static void main(String[] args) {

        try {
            String tgt = getTGT("admin", "admin");
            System.out.println("TGT：" + tgt);

            String service = "http://localhost:58080/springboot/swagger-ui.html";
